...
<html lang="en">
<head>
    <title>Butterfly Kisses Luxury Picnic ▦ About</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <main>
        ...
        <?php echo "<p>
        At <strong><span class="color">Butterfly Kisses Luxury Picnic</strong>, we understand that every guest deserves a special and memorable day. Our passion for creating memorable and enjoyable experiences is what drives us to continue to provide you with the best possible services.
        ...
        <br>
        <br>
        We are proud of our work and are committed to creating a safe and enjoyable environment for our guests. We are always here to help you find the perfect picnic experience that suits your needs and preferences.
        By continuing to work at our events, we will give you the best possible services for your events.
        Always to bring a vibe, create a new style event, and to have a great time with our guests.
        <br>
        <br>
        I'd love to hear how you want your events. We can make your events more fun, creative, relaxing & lively.
        We are always here to help. Every Event, you make us go harder at our future events.
        <br>
        <br>
        The <strong><span class="color">Butterfly Kisses Luxury Picnic</strong> will help you with Date Nights, Birthdays & Anniversaries, to make event dreams come true.
    ...
    <a href="https://www.instagram.com/house_belinda/" class="social-media-link" target="_blank"><i class="fab fa-instagram"></i></a>
        ...
        <footer>
                <div class="container">
                <p>
                &copy; <span id="year"></span> Butterfly Kisses Luxury Picnic. All rights reserved. | <a href="mailto:belindahouse40@gmail.com">belindahouse40@gmail.com</a><br>
